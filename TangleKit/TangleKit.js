...
(function () {
  ...
  Tangle.classes.TKAdjustableNumber = {
    ...
    isActive: function () {
      return (
        this.isDragging || (this.isHovering && !isAnyAdjustableNumberDragging)
      );
    },
    ...
    updateHelp: function () {
      ...
      var display =
        this.isHovering && !isAnyAdjustableNumberDragging ? "block" : "none";
    ...
    touchDidMove: function (touches) {
      var value =
        this.valueAtMouseDown + (touches.translation.x / 5) * this.step;
      value = ((value / this.step).round() * this.step).limit(
        this.min,
        this.max
      );
